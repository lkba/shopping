...
import com.lkb.service.goods.AlbumService;
...
public class AlbumController {
    ...
    public String findListById(Long id){
        Album album= albumService.findById(id);
        String str=album.getImageItems();
        return str;
    }

    @PostMapping("/add_image_items")
    public Result findPage(@RequestBody Album album,Long id){
        System.out.println(album.getImageItems());
        System.out.println(id);
        albumService.add_image_items(album,id);
        return new Result();
    }
