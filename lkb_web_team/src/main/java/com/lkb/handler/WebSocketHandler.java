package com.lkb.handler;

import com.alibaba.fastjson.JSONObject;
import com.lkb.config.NettyConfig;
import com.lkb.constant.WebSocketConstant;
import com.lkb.model.User;
import com.lkb.service.MessageService;
    ...
    private void handWebsocketFrame(ChannelHandlerContext ctx, WebSocketFrame frame) {
        ...
        switch (code) {
            ...
            case GROUP_CHAT_CODE:
                //向每个连接上来的客户端群发群聊消息
                tws = new TextWebSocketFrame(messageService.messageJSONStringFactory(GROUP_CHAT_MESSAGE_CODE, chatMessage, user, null));
                NettyConfig.channelGroup.writeAndFlush(tws);
                break;
            //私聊
