...
public class CartServiceImpl implements CartService {
    ...
    public void addItem(String username, String skuId, Integer num) {
        ...
        //如果购物车中没有该商品，则添加
//        System.out.println("skuService:"+skuService.findAll());
        if(flag==false){
    ...
    @Override
    public int preferential(String username,String isPass) {
        ...
        for( Integer categoryId:  cartMap.keySet() ){
            ...
            int preMoney = preferentialService.findPreMoneyByCategoryId(categoryId, money,isPass); //获取优惠金额
