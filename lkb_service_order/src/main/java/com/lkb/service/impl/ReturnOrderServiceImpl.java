...
import com.lkb.dao.ReturnOrderItemMapper;
import com.lkb.dao.ReturnOrderMapper;
import com.lkb.entity.PageResult;
import com.lkb.pojo.order.OrderItem;
import com.lkb.pojo.order.ReturnOrder;
import com.lkb.pojo.order.ReturnOrderItem;
import com.lkb.service.order.ReturnOrderService;
...
//调用支付平台的退款接口
    ...
    @Override
    public void agreeReturn(String id, Integer money, Integer adminId) {
        ReturnOrder returnOrder =
                returnOrderMapper.selectByPrimaryKey(id);
        if (returnOrder == null) {
...
//调用支付平台的退款接口
    ...
    @Override
    public void rejectReturn(String id, String remark, Integer adminId) {
        ReturnOrder returnOrder =
                returnOrderMapper.selectByPrimaryKey(id);
        if (returnOrder == null) {
            throw new RuntimeException("退货订单不存在！");
