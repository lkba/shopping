...
//            System.out.println();
            ...
            //上传到ES
//            Map skuMapES=objectToMap(sku);
////            skuMapES.put("name",sku.getName());
//            uploadSkuToEs(skuMapES);
     ...
     * 上传到ES
     */
    private void uploadSkuToEs(Map map) throws IOException {
        //            //1.连接rest接口
...
//            //添加到ES中
        ...
        IndexRequest indexRequest = new IndexRequest("sku", "doc", (String) map.get("id"));//： 新增或修改请求
        System.out.println((String) map.get("id"));
        Map skuMap = new HashMap();
        skuMap.put("status", map.get("status"));
        skuMap.put("sn", map.get("sn"));
        skuMap.put("spuId", map.get("spuId"));
//        skuMap.put("name", map.get("name"));
//        skuMap.put("price", map.get("price"));
//        skuMap.put("createTime", map.get("createTime"));
//        skuMap.put("commentNum", map.get("commentNum"));
//        skuMap.put("categoryName", map.get("categoryName"));
//        skuMap.put("saleNum", map.get("saleNum"));
//        skuMap.put("weight", map.get("weight"));
//        skuMap.put("num", map.get("num"));
//        skuMap.put("brandName",map.get("brandName"));
//        skuMap.put("images", map.get("images"));
//        skuMap.put("alertNum", map.get("alertNum"));
//        skuMap.put("image", map.get("image"));
////            Map specEs=new HashMap();
////            specEs.put("网络制式","移动4G");
////            specEs.put("屏幕尺寸","5");
//        skuMap.put("spec", map.get("spec"));
...
//        restHighLevelClient.close();
    ...
    public static Map<String, Object> objectToMap(Sku obj) throws Exception {
        if(obj == null){
            return null;
        }
        Map<String, Object> map = new HashMap<String, Object>();
        Field[] declaredFields = obj.getClass().getDeclaredFields(); //java.lang.reflect.Field
    ...
    public void audit(String id, String status, String message) {
        ...
        Date date = new Date();
        if ("1".equals(status)) {//审核通过
            auditing.setResult("1");
        } else {
            auditing.setResult("0");
        }
        auditing.setAuditTime(date);
        auditing.setSpu_id(id);
        auditing.setDetails(message);
