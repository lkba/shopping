...
import com.lkb.dao.AlbumMapper;
...
public class AlbumServiceImpl implements AlbumService {
    ...
    public void add_image_items(Album album, Long id){
        Album album_old=albumMapper.selectByPrimaryKey(id);
        album_old.setImageItems(album.getImageItems());
        albumMapper.updateByPrimaryKeySelective(album_old);
    }
